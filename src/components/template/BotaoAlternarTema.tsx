...
export default function BotaoAlternarTema(props: BotaoAlternarTema) {
    return props.tema === 'dark' ? (
        // sm:flex significa tipo o ponto de parada
        // tudo que tiver antes vai ser usado em telas menores que sm
        // tudo que tiver depois vai ser usado em telas maiores que sm
